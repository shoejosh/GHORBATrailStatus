...
public class TrailReportActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TextView tvCurrentUsername = (TextView) findViewById(R.id.tvCurrentUsername);
        tvCurrentUsername.setText("Posting as " + GhorbaSiteActions.getUsername() + ": ");
    }
